...
OPT     += -DHDF5     # Output extra diagnostics to file
...
HDF_LIBS = -L/usr/lib/x86_64-linux-gnu/hdf5/serial/ -lhdf5 -lz
HDF_INCL = -I/usr/include/hdf5/serial/ -DH5_USE_16_API
...
CFLAGS  = -std=c99 -fopenmp $(OPTIMIZE) $(OPT) $(GSL_INCL) $(PNG_INCL) $(HDF_INCL)

LINK    = $(GSL_LIBS) -lm -lgsl -lgslcblas $(PNG_LIBS) $(HDF_LIBS)
