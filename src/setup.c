...
const double UVel = 20733964.4;			    // in cgs
const double UDensity = UMass / p3(ULength);
const double UEnergy = p2(UVel);
...
void setup_problem ( const int Flag, const int Subflag )
{
    ...
    case 6:
        ...
        case 2:
            ...
            break;
        case 3:
            setup_isothermal_sphere();
            break;
        case 4:
            setup_isothermal_torus();
            break;
        default:
            Assert ( false, "User test not implemented yet", Flag, Subflag );
            break;
        }
        break;
