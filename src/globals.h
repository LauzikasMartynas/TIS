...
#define DESNNGB 195        // SPH kernel weighted number of neighbours
#define NNGBDEV 0.05       // error tolerance in SPH kernel weighted neighb.
#define NGBMAX (DESNNGB*8)  // size of neighbour list
...
extern const double ULength, UMass, UVel, UEnergy, UDensity; // Standard Gadget units (setup.c)
...
extern double G; // gravitational constant in code units
